      ...
      <CardContent>
        <form action={acao} className="grid gap-5 md:grid-cols-2">
          <div className="space-y-1.5">
            <Label htmlFor="janelaComparecimentoHoras">Janela de agendamento (horas)</Label>
            <Input
          ...
          <div className="space-y-1.5">
            <Label htmlFor="politicaCheckinSemComparecimento">Check-in sem agendamento</Label>
            <Select
          ...
          <div className="space-y-1.5">
            ...
            >
              ...
              <option value="BLOQUEAR_COMPARECIMENTO">Bloquear agendamento</option>
          ...
          <fieldset className="space-y-3 rounded-md border border-border p-4 md:col-span-2">
            ...
            <label className="flex items-center gap-2 text-sm">
              ...
              />
              Exigir agendamento prévio para check-in do aluno
            </label>
            <label className="flex items-center gap-2 text-sm">
              <input
                type="checkbox"
