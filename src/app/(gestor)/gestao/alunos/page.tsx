    ...
    <div className="space-y-6">
      ...
      <TabelaAlunos
        ...
        alunos={alunos.map((a) => ({
          ...
          termoResponsabilidadeAceito: a.aceitesTermoResponsabilidade.length > 0,
          termoResponsabilidadeAceitoEm: a.aceitesTermoResponsabilidade[0]?.aceitoEm ?? null,
          termoResponsabilidadeVersao: a.aceitesTermoResponsabilidade[0]?.termoVersao ?? null,
