...
export async function MinhasHorasAluno({ alunoId }: { alunoId: string }) {
  ...
  return (
    <section className="space-y-4" aria-labelledby="minhas-horas-titulo">
      <div>
        <h2 id="minhas-horas-titulo" className="text-lg font-bold tracking-tight">
          Minhas horas
        </h2>
