...
| Divisão de receita, custos fixos e repasses (RF-053.1/RF-053.2/RF-064.1/RN-017/RN-018/RN-021) | `Modalidade.valorRepasseProfessor`,`Mensalidade.repasseSnapshot`,`RegistroImportado.valorRepasse`,`CustoFixoMensal` | `calcularRepasseFinanceiro`, `calcularDistribuicaoSobraFinanceira`, `custos-fixos.service.ts`, `modalidade.service.ts`, `gestao/modalidades`, `gestao/financeiro/repasses` |
