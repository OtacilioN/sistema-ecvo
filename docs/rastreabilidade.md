...
| Autocadastro com plano padrão, primeira mensalidade Asaas obrigatória, comprovante privado opcional e aprovação administrativa (RF-001.1/001.2/RF-020/RF-046..048/RF-053.3/RF-079) | `Plano.padrao`,`SolicitacaoMatricula`,`CobrancaMatriculaAsaas`,`Usuario`,`Aluno`,`AlunoPlanoModalidade`,`Mensalidade`,`CobrancaAsaas`,`LogAuditoria` | `src/lib/services/matricula.service.ts`, `src/lib/services/pagamento-matricula.service.ts`, `src/lib/validations/matricula.ts`, `src/app/actions/matriculas.ts`, `src/app/(auth)/matricula`, `gestao/matriculas-pendentes`, `api/comprovantes-matricula/[id]`, `api/webhooks/asaas`, `checkin.service.ts` |
