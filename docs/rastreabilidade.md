...
| Check-in por botão, QR Code, lançamento por professor/gestor, histórico e validações de status, financeiro, comparecimento e vagas (RF-019..024) | `Checkin` | `src/lib/services/checkin.service.ts`, `src/app/actions/treino.ts`, `professor/aula/[id]`, `aluno/checkin/[aulaId]`, `aluno/perfil` |
